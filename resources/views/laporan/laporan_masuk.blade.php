                        ...
                        <form>
                            <div>
                                <div class="d-flex gap-2 justify-content-start">
                                    <a class="btn btn-primary col-1 rounded-0" href="{{ route('laporanmasuk.exportExcel') }}" >
                                        Excel
                                    </a>
                                    <a class="btn btn-outline-primary col-1 rounded-0" href="{{ route('laporanmasuk.exportPdf') }}">
                                        Pdf
                                    </a>
                                </div> 
                            </div>
